...
### Create (Default)
```
New-AzsDiskMigrationJob -MigrationId <String> -TargetShare <String> -Disk <IDisk[]> [-Location <String>]
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CreateViaIdentity
```
New-AzsDiskMigrationJob -InputObject <IComputeAdminIdentity> -TargetShare <String> -Disk <IDisk[]>
...
#### DISK <IDisk[]>: HELP MESSAGE MISSING

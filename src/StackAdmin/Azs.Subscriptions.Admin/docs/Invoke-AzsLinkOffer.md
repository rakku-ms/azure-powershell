...
online version: https://docs.microsoft.com/en-us/powershell/module/azs.subscriptions.admin/invoke-azslinkoffer
schema: 2.0.0
---
...
```
Invoke-AzsLinkOffer -Offer <String> -ResourceGroupName <String> [-SubscriptionId <String>]
...
### Link
```
Invoke-AzsLinkOffer -Offer <String> -ResourceGroupName <String> -PlanLink <IPlanLinkDefinition>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### LinkViaIdentity
```
Invoke-AzsLinkOffer -InputObject <ISubscriptionsAdminIdentity> -PlanLink <IPlanLinkDefinition>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### LinkViaIdentityExpanded
```
Invoke-AzsLinkOffer -InputObject <ISubscriptionsAdminIdentity> [-MaxAcquisitionCount <Int32>]

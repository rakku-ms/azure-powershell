...
```
New-AzsOffer -InputObject <ISubscriptionsAdminIdentity> [-AddonPlan <IAddonPlanDefinition[]>]
 [-BasePlanId <String[]>] [-Description <String>] [-DisplayName <String>] [-ExternalReferenceId <String>]

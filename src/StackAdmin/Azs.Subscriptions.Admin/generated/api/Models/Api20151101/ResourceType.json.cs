namespace Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Models.Api20151101
{
    ...
    public partial class ResourceType
    {
        ...
        internal ResourceType(Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonObject json)
        {
            ...
            {_apiProfile = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonObject>("apiProfiles"), out var __jsonApiProfiles) ? Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Models.Api20151101.ApiProfileList.FromJson(__jsonApiProfiles) : ApiProfile;}
            {_authorizationActionMapping = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonObject>("authorizationActionMappings"), out var __jsonAuthorizationActionMappings) ? Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Models.Api20151101.AuthorizationActionMappingList.FromJson(__jsonAuthorizationActionMappings) : AuthorizationActionMapping;}
            {_endpoint = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonObject>("endpoints"), out var __jsonEndpoints) ? Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Models.Api20151101.ResourceProviderEndpointList.FromJson(__jsonEndpoints) : Endpoint;}
            {_linkedAccessCheck = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonObject>("linkedAccessChecks"), out var __jsonLinkedAccessChecks) ? Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Models.Api20151101.LinkedAccessCheckList.FromJson(__jsonLinkedAccessChecks) : LinkedAccessCheck;}
            {_linkedNotificationRule = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonObject>("linkedNotificationRules"), out var __jsonLinkedNotificationRules) ? Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Models.Api20151101.LinkedNotificationRuleList.FromJson(__jsonLinkedNotificationRules) : LinkedNotificationRule;}
            {_linkedOperationRule = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonObject>("linkedOperationRules"), out var __jsonLinkedOperationRules) ? Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Models.Api20151101.LinkedOperationRuleList.FromJson(__jsonLinkedOperationRules) : LinkedOperationRule;}
            ...
            {_allowedUnauthorizedAction = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonArray>("allowedUnauthorizedActions"), out var __jsonAllowedUnauthorizedActions) ? If( __jsonAllowedUnauthorizedActions as Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(string) (__u is Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonString __t ? (string)(__t.ToString()) : null)) ))() : null : AllowedUnauthorizedAction;}
            ...
            {_meteredResourceId = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonArray>("meteredResourceIds"), out var __jsonMeteredResourceIds) ? If( __jsonMeteredResourceIds as Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<string[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(string) (__p is Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonString __o ? (string)(__o.ToString()) : null)) ))() : null : MeteredResourceId;}
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._apiProfile ? (Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonNode) this._apiProfile.ToJson(null,serializationMode) : null, "apiProfiles" ,container.Add );
            AddIf( null != this._authorizationActionMapping ? (Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonNode) this._authorizationActionMapping.ToJson(null,serializationMode) : null, "authorizationActionMappings" ,container.Add );
            AddIf( null != this._endpoint ? (Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonNode) this._endpoint.ToJson(null,serializationMode) : null, "endpoints" ,container.Add );
            AddIf( null != this._linkedAccessCheck ? (Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonNode) this._linkedAccessCheck.ToJson(null,serializationMode) : null, "linkedAccessChecks" ,container.Add );
            AddIf( null != this._linkedNotificationRule ? (Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonNode) this._linkedNotificationRule.ToJson(null,serializationMode) : null, "linkedNotificationRules" ,container.Add );
            AddIf( null != this._linkedOperationRule ? (Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonNode) this._linkedOperationRule.ToJson(null,serializationMode) : null, "linkedOperationRules" ,container.Add );

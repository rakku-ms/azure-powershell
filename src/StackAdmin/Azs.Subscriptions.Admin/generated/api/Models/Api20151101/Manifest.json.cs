namespace Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Models.Api20151101
{
    ...
    public partial class Manifest
    {
        ...
        internal Manifest(Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonObject json)
        {
            ...
            {_linkedNotificationRule = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonObject>("linkedNotificationRules"), out var __jsonLinkedNotificationRules) ? Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Models.Api20151101.FanoutLinkedNotificationRuleList.FromJson(__jsonLinkedNotificationRules) : LinkedNotificationRule;}
            ...
            {_resourceHydrationAccount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonObject>("resourceHydrationAccounts"), out var __jsonResourceHydrationAccounts) ? Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Models.Api20151101.AzureResourceHydrationAccountList.FromJson(__jsonResourceHydrationAccounts) : ResourceHydrationAccount;}
            {_resourceType = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonObject>("resourceTypes"), out var __jsonResourceTypes) ? Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Models.Api20151101.ResourceTypeList.FromJson(__jsonResourceTypes) : ResourceType;}
            ...
            {_metadata = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonObject>("metadata"), out var __jsonMetadata) ? Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Models.Api20151101.ManifestMetadata.FromJson(__jsonMetadata) : Metadata;}
            ...
            {_resourceTag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonObject>("resourceTags"), out var __jsonResourceTags) ? Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Models.Api20151101.ManifestResourceTags.FromJson(__jsonResourceTags) : ResourceTag;}
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._resourceHydrationAccount ? (Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonNode) this._resourceHydrationAccount.ToJson(null,serializationMode) : null, "resourceHydrationAccounts" ,container.Add );
            AddIf( null != this._resourceType ? (Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonNode) this._resourceType.ToJson(null,serializationMode) : null, "resourceTypes" ,container.Add );
            ...
            AddIf( null != this._resourceTag ? (Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonNode) this._resourceTag.ToJson(null,serializationMode) : null, "resourceTags" ,container.Add );

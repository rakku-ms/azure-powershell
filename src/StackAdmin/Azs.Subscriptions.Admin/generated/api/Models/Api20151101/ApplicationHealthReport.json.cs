namespace Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Models.Api20151101
{
    ...
    public partial class ApplicationHealthReport
    {
        ...
        internal ApplicationHealthReport(Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonObject json)
        {
            ...
            {_appRoleAssignment = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonObject>("appRoleAssignments"), out var __jsonAppRoleAssignments) ? Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Models.Api20151101.AppRoleAssignmentHealthReportList.FromJson(__jsonAppRoleAssignments) : AppRoleAssignment;}
            {_oAuth2PermissionGrant = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonObject>("oAuth2PermissionGrants"), out var __jsonOAuth2PermissionGrants) ? Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Models.Api20151101.OAuth2PermissionGrantHealthReportList.FromJson(__jsonOAuth2PermissionGrants) : OAuth2PermissionGrant;}
            {_servicePrincipalTag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonObject>("servicePrincipalTags"), out var __jsonServicePrincipalTags) ? Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Models.Api20151101.ServicePrincipalTagHealthReportList.FromJson(__jsonServicePrincipalTags) : ServicePrincipalTag;}
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._appRoleAssignment ? (Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonNode) this._appRoleAssignment.ToJson(null,serializationMode) : null, "appRoleAssignments" ,container.Add );
            AddIf( null != this._oAuth2PermissionGrant ? (Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonNode) this._oAuth2PermissionGrant.ToJson(null,serializationMode) : null, "oAuth2PermissionGrants" ,container.Add );
            AddIf( null != this._servicePrincipalTag ? (Microsoft.Azure.PowerShell.Cmdlets.SubscriptionsAdmin.Runtime.Json.JsonNode) this._servicePrincipalTag.ToJson(null,serializationMode) : null, "servicePrincipalTags" ,container.Add );

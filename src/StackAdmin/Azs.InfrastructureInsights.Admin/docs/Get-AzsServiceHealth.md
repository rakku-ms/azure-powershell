...
online version: https://docs.microsoft.com/en-us/powershell/module/azs.infrastructureinsights.admin/get-azsservicehealth
schema: 2.0.0
---
...
### List (Default)
```
Get-AzsServiceHealth -ResourceGroupName <String> [-Location <String>] [-SubscriptionId <String[]>]
 [-Filter <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzsServiceHealth -ResourceGroupName <String> -ServiceHealth <String> [-Location <String>]
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzsServiceHealth -InputObject <IInfrastructureInsightsAdminIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

...
```
Close-AzsAlert -Name <String> -ResourceGroupName <String> -User <String> [-Location <String>]
...
### Close
```
Close-AzsAlert -Name <String> -ResourceGroupName <String> -User <String> -Alert <IAlert> [-Location <String>]

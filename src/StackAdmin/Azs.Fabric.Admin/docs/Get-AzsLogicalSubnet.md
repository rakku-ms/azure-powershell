...
### List (Default)
```
Get-AzsLogicalSubnet -LogicalNetwork <String> -ResourceGroupName <String> [-Location <String>]
 [-SubscriptionId <String[]>] [-Filter <String>] [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### Get
```
Get-AzsLogicalSubnet -LogicalNetwork <String> -LogicalSubnet <String> -ResourceGroupName <String>

...
online version: https://docs.microsoft.com/en-us/powershell/module/azs.fabric.admin/start-azsinfraroleinstance
schema: 2.0.0
---

# Start-AzsInfraRoleInstance
...
### PowerOn (Default)
```
Start-AzsInfraRoleInstance -InfraRoleInstance <String> -ResourceGroupName <String> [-Location <String>]
...
### PowerOnViaIdentity
```
Start-AzsInfraRoleInstance -InputObject <IFabricAdminIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]

...
### List (Default)
```
Get-AzsScaleUnit -ResourceGroupName <String> [-Location <String>] [-SubscriptionId <String[]>]
 [-Filter <String>] [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### Get
```
Get-AzsScaleUnit -ResourceGroupName <String> -ScaleUnit <String> [-Location <String>]

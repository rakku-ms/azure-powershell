...
online version: https://docs.microsoft.com/en-us/powershell/module/azs.fabric.admin/restart-azsinfraroleinstance
schema: 2.0.0
---

# Restart-AzsInfraRoleInstance
...
### Reboot (Default)
```
Restart-AzsInfraRoleInstance -InfraRoleInstance <String> -ResourceGroupName <String> [-Location <String>]
...
### RebootViaIdentity
```
Restart-AzsInfraRoleInstance -InputObject <IFabricAdminIdentity> [-DefaultProfile <PSObject>] [-AsJob]

...
online version: https://docs.microsoft.com/en-us/powershell/module/azs.fabric.admin/stop-azsinfraroleinstance
schema: 2.0.0
---
...
### PowerOff (Default)
```
Stop-AzsInfraRoleInstance -InfraRoleInstance <String> -ResourceGroupName <String> [-Location <String>]
...
### PowerOffViaIdentity
```
Stop-AzsInfraRoleInstance -InputObject <IFabricAdminIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]

...
### List (Default)
```
Get-AzsLogicalNetwork -ResourceGroupName <String> [-Location <String>] [-SubscriptionId <String[]>]
 [-Filter <String>] [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### Get
```
Get-AzsLogicalNetwork -LogicalNetwork <String> -ResourceGroupName <String> [-Location <String>]

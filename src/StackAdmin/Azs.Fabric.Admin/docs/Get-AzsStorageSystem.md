...
### List (Default)
```
Get-AzsStorageSystem -ResourceGroupName <String> [-Location <String>] [-SubscriptionId <String[]>]
 [-Filter <String>] [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### Get
```
Get-AzsStorageSystem -ResourceGroupName <String> -StorageSubSystem <String> [-Location <String>]

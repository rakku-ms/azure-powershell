...
### List (Default)
```
Get-AzsMacAddressPool -ResourceGroupName <String> [-Location <String>] [-SubscriptionId <String[]>]
 [-Filter <String>] [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### Get
```
Get-AzsMacAddressPool -MacAddressPool <String> -ResourceGroupName <String> [-Location <String>]

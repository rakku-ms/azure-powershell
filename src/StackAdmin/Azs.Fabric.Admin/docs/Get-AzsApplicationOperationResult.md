...
online version: https://docs.microsoft.com/en-us/powershell/module/azs.fabric.admin/get-azsapplicationoperationresult
schema: 2.0.0
---

# Get-AzsApplicationOperationResult
...
### List (Default)
```
Get-AzsApplicationOperationResult -ResourceGroupName <String> [-Location <String>]
 [-SubscriptionId <String[]>] [-Filter <String>] [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### Get
```
Get-AzsApplicationOperationResult -Operation <String> -ResourceGroupName <String> [-Location <String>]
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzsApplicationOperationResult -InputObject <IFabricAdminIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20160501.IApplicationOperationResult

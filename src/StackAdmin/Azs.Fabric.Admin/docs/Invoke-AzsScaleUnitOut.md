...
online version: https://docs.microsoft.com/en-us/powershell/module/azs.fabric.admin/invoke-azsscaleunitout
schema: 2.0.0
---

# Invoke-AzsScaleUnitOut
...
```
Invoke-AzsScaleUnitOut -ResourceGroupName <String> -ScaleUnit <String> [-Location <String>]
...
### Scale
```
Invoke-AzsScaleUnitOut -ResourceGroupName <String> -ScaleUnit <String>
 -ScaleNodeList <IScaleOutScaleUnitParametersList> [-Location <String>] [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ScaleViaIdentity
```
Invoke-AzsScaleUnitOut -InputObject <IFabricAdminIdentity> -ScaleNodeList <IScaleOutScaleUnitParametersList>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### ScaleViaIdentityExpanded
```
Invoke-AzsScaleUnitOut -InputObject <IFabricAdminIdentity> [-AwaitStorageConvergence]
...
To construct, see NOTES section for SCALENODELIST properties and create a hash table.
...
#### SCALENODELIST <IScaleOutScaleUnitParametersList>: A list of input data that allows for adding a set of scale unit nodes.

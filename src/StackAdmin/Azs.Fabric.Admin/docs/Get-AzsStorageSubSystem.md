...
### List (Default)
```
Get-AzsStorageSubSystem -ResourceGroupName <String> -ScaleUnit <String> [-Location <String>]
 [-SubscriptionId <String[]>] [-Filter <String>] [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### Get
```
Get-AzsStorageSubSystem -ResourceGroupName <String> -ScaleUnit <String> -StorageSubSystem <String>

...
```
New-AzsIPPool -IPPool <String> -ResourceGroupName <String> [-Location <String>] [-SubscriptionId <String>]
...
### Create
```
New-AzsIPPool -IPPool <String> -ResourceGroupName <String> -Pool <IIPPool> [-Location <String>]

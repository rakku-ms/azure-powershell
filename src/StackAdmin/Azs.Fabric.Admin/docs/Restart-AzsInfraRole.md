...
online version: https://docs.microsoft.com/en-us/powershell/module/azs.fabric.admin/restart-azsinfrarole
schema: 2.0.0
---

# Restart-AzsInfraRole
...
### Restart (Default)
```
Restart-AzsInfraRole -InfraRole <String> -ResourceGroupName <String> [-Location <String>]
...
### RestartViaIdentity
```
Restart-AzsInfraRole -InputObject <IFabricAdminIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]

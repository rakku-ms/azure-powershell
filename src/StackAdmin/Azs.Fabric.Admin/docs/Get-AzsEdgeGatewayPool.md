...
### List (Default)
```
Get-AzsEdgeGatewayPool -ResourceGroupName <String> [-Location <String>] [-SubscriptionId <String[]>]
 [-Filter <String>] [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### Get
```
Get-AzsEdgeGatewayPool -EdgeGatewayPool <String> -ResourceGroupName <String> [-Location <String>]

...
### List (Default)
```
Get-AzsDrive -ResourceGroupName <String> -ScaleUnit <String> -StorageSubSystem <String> [-Location <String>]
 [-SubscriptionId <String[]>] [-Filter <String>] [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### Get
```
Get-AzsDrive -Drive <String> -ResourceGroupName <String> -ScaleUnit <String> -StorageSubSystem <String>
...
### Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20181001.IDrive

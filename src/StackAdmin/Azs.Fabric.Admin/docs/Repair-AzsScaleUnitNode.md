...
```
Repair-AzsScaleUnitNode -ResourceGroupName <String> -ScaleUnitNode <String> [-Location <String>]
...
### Repair
```
Repair-AzsScaleUnitNode -ResourceGroupName <String> -ScaleUnitNode <String>
 -BareMetalNode <IBareMetalNodeDescription> [-Location <String>] [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

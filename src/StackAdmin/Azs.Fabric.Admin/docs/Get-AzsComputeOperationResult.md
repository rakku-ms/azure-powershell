...
online version: https://docs.microsoft.com/en-us/powershell/module/azs.fabric.admin/get-azscomputeoperationresult
schema: 2.0.0
---

# Get-AzsComputeOperationResult
...
### List (Default)
```
Get-AzsComputeOperationResult -ResourceGroupName <String> [-Location <String>] [-SubscriptionId <String[]>]
 [-Filter <String>] [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### Get
```
Get-AzsComputeOperationResult -Operation <String> -ResourceGroupName <String> [-Location <String>]
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzsComputeOperationResult -InputObject <IFabricAdminIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.Api20160501.IComputeOperationResult

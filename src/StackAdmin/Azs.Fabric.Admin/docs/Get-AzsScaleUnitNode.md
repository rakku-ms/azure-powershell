...
### List (Default)
```
Get-AzsScaleUnitNode -ResourceGroupName <String> [-Location <String>] [-SubscriptionId <String[]>]
 [-Filter <String>] [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### Get
```
Get-AzsScaleUnitNode -ResourceGroupName <String> -ScaleUnitNode <String> [-Location <String>]

...
online version: https://docs.microsoft.com/en-us/powershell/module/azs.fabric.admin/start-azsscaleunitnodemaintenancemode
schema: 2.0.0
---
...
### Start (Default)
```
Start-AzsScaleUnitNodeMaintenanceMode -ResourceGroupName <String> -ScaleUnitNode <String> [-Location <String>]
...
### StartViaIdentity
```
Start-AzsScaleUnitNodeMaintenanceMode -InputObject <IFabricAdminIdentity> [-DefaultProfile <PSObject>]

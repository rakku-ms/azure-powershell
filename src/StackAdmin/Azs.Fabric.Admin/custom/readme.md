...
- `Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.DescriptionAttribute`
  - Used in C# cmdlets to provide a high-level description of the cmdlet. This is propegated to reference documentation via [help comments](https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_comment_based_help) in the exported scripts.
- `Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.DoNotExportAttribute`
...
- `Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.InternalExportAttribute`
...
- `Microsoft.Azure.PowerShell.Cmdlets.FabricAdmin.Models.ProfileAttribute`

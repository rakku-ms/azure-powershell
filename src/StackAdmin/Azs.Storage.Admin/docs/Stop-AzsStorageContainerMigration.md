...
online version: https://docs.microsoft.com/en-us/powershell/module/azs.storage.admin/stop-azsstoragecontainermigration
schema: 2.0.0
---
...
### Cancel (Default)
```
Stop-AzsStorageContainerMigration -FarmName <String> -OperationId <String> -ResourceGroupName <String>
...
### CancelViaIdentity
```
Stop-AzsStorageContainerMigration -InputObject <IStorageAdminIdentity> [-DefaultProfile <PSObject>] [-AsJob]

...
online version: https://docs.microsoft.com/en-us/powershell/module/azs.storage.admin/get-azsfarmgarbagecollectionstate
schema: 2.0.0
---

# Get-AzsFarmGarbageCollectionState
...
### Get (Default)
```
Get-AzsFarmGarbageCollectionState -FarmId <String> -OperationId <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzsFarmGarbageCollectionState -InputObject <IStorageAdminIdentity> [-DefaultProfile <PSObject>]

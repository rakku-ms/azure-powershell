...
online version: https://docs.microsoft.com/en-us/powershell/module/azs.storage.admin/get-azsqueueservice
schema: 2.0.0
---
...
### Get (Default)
```
Get-AzsQueueService -FarmId <String> -ResourceGroupName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzsQueueService -InputObject <IStorageAdminIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```

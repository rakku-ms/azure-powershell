...
online version: https://docs.microsoft.com/en-us/powershell/module/azs.storage.admin/invoke-azsmigrationcontainerstatus
schema: 2.0.0
---

# Invoke-AzsMigrationContainerStatus
...
### Migration (Default)
```
Invoke-AzsMigrationContainerStatus -FarmId <String> -OperationId <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### MigrationViaIdentity
```
Invoke-AzsMigrationContainerStatus -InputObject <IStorageAdminIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

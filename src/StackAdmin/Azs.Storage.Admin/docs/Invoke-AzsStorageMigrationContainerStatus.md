...
online version: https://docs.microsoft.com/en-us/powershell/module/azs.storage.admin/invoke-azsstoragemigrationcontainerstatus
schema: 2.0.0
---

# Invoke-AzsStorageMigrationContainerStatus
...
### Migration (Default)
```
Invoke-AzsStorageMigrationContainerStatus -FarmName <String> -OperationId <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### MigrationViaIdentity
```
Invoke-AzsStorageMigrationContainerStatus -InputObject <IStorageAdminIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
Parameter Sets: MigrationViaIdentity
Aliases:

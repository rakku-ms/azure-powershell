...
online version: https://docs.microsoft.com/en-us/powershell/module/azs.storage.admin/get-azsfarm
schema: 2.0.0
---
...
### List (Default)
```
Get-AzsFarm -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```

### Get
```
Get-AzsFarm -Id <String> -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>]
 [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzsFarm -InputObject <IStorageAdminIdentity> [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

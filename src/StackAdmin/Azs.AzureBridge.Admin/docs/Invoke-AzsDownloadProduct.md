...
online version: https://docs.microsoft.com/en-us/powershell/module/azs.azurebridge.admin/invoke-azsdownloadproduct
schema: 2.0.0
---

# Invoke-AzsDownloadProduct
...
### Download (Default)
```
Invoke-AzsDownloadProduct -ActivationName <String> -ProductName <String> -ResourceGroup <String>
...
### DownloadViaIdentity
```
Invoke-AzsDownloadProduct -InputObject <IBridgeAdminIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]

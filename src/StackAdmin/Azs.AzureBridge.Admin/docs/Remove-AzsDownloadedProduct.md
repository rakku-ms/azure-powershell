...
online version: https://docs.microsoft.com/en-us/powershell/module/azs.azurebridge.admin/remove-azsdownloadedproduct
schema: 2.0.0
---

# Remove-AzsDownloadedProduct
...
### Delete (Default)
```
Remove-AzsDownloadedProduct -ActivationName <String> -ProductName <String> -ResourceGroup <String>
...
### DeleteViaIdentity
```
Remove-AzsDownloadedProduct -InputObject <IBridgeAdminIdentity> [-DefaultProfile <PSObject>] [-AsJob]

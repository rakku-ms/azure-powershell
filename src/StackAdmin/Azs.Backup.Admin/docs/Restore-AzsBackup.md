...
```
Restore-AzsBackup -Backup <String> -ResourceGroupName <String> [-Location <String>] [-SubscriptionId <String>]
 [-DecryptionCertBase64 <String>] [-DecryptionCertPassword <String>] [-RoleName <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Restore
```
Restore-AzsBackup -Backup <String> -ResourceGroupName <String> -RestoreOption <IRestoreOptions>
 [-Location <String>] [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru]
...
```
Restore-AzsBackup -InputObject <IBackupAdminIdentity> [-DecryptionCertBase64 <String>]
 [-DecryptionCertPassword <String>] [-RoleName <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
